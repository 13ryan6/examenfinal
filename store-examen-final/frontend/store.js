...
function listProducts() {
    ...
    fetch("http://localhost:80/store-examen-final/backend/listProducts.php")
    // --
...
function order(){
    ...
    fetch('http://localhost:80/store-examen-final/backend//order.php', {method:'post', body:jsonOrder})
